...
public class Sim {
	...
	public static List<Chunk> mapChunks = new ArrayList<Chunk>();
...
//			System.out.println(mapChunks.get(i).type);
//			System.out.println(mapChunks.get(i).densityPercent);
//			if(mapChunks.get(i).type == "car") {
//				mapChunks.get(i).densityPercent = mapChunks.get(i).densityPercent - 50;
//			}else {
//				mapChunks.get(i).densityPercent = mapChunks.get(i).densityPercent + 50;
//			}
//			System.out.println(mapChunks.get(i).densityPercent + "\n");
...
//		createPlayerPairings(playerList, characterList);
	...
	public static void generateChunks() {
		Chunk building = new Chunk(100, 100, 100, 100, "solid", "building");
		Chunk car = new Chunk(100, 4.5, 3, 2.5, "solid", "car");
		mapChunks.add(car);
		mapChunks.add(building);
	}
	...
	public static int searchChunks(String s) {
		int i = 0;
		for(int j = 0; j < mapChunks.size(); j++) {
			if(mapChunks.get(j).type == s) {
				i = j;
			}
		}
		return i;
